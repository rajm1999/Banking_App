...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
       ...
       db.execSQL(sql_tr);
       //to insert data
        insertData("RAJAT","rajat@gmail.com",5000,"9255572698","XXXXXXXXXXXX4735",db);
        insertData("RAJ","raj1999@gmail.com",15000,"802339459","XXXXXXXXXXXX1344",db);
        insertData("RAHUL","rahulmalhotra@gmail.com",25000,"2225137174 ","XXXXXXXXXXXX3234",db);
        insertData("ROHAN","rohanyadav@gmail.com",56000,"2228073554","XXXXXXXXXXXX1284",db);
        insertData("RAGHAV","raghavjain@gmail.com",54000,"9257472698","XXXXXXXXXXXX1534",db);
        insertData("VIPUL","vipuljk@gmail.com",30000,"9834572698","XXXXXXXXXXXX1294",db);
        insertData("DHRUV","dhruvyadav@gmail.com",70000,"999972698","XXXXXXXXXXXX1034",db);
        insertData("JATIN","jatinlakhani@gmail.com",85000,"925559876","XXXXXXXXXXXX4234",db);
        insertData("ANURAG","anuragkumar@gmail.com",25000,"9255234568","XXXXXXXXXXXX1534",db);
        insertData("HIMANSHU","himanshurai@gmail.com",45000,"9234567698","XXXXXXXXXXXX8734",db);
